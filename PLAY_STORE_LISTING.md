# Play Store listing — Morse Code (شيفرة مورس)
...
- **Package name**: `org.workshopdiy.morsecode`
...
### App name
```
Morse Code — Morse Kids Lab
```

### Short description
```
Morse Kids Lab — micro:bit BLE app for kids
```
...
### Short description
```
Morse Kids Lab — application micro:bit BLE
```
...
```
Privacy Policy — Morse Code
Last updated: 2026-04-27

The Morse Code app does not collect, store, transmit, or share any personal
